...
;v6.05 Changes 7-24-19
;	RZ
;		Modified
;			Vegarlson: The Terene Rift
;				Moved zone in spot closer for Heroic and Expert as well
;	RI
;		Added a workaround for ISXEQ2 Actor Member IsSwimming not functioning
;		Modified
;			Vegarlson: The Terene Rift
;				Krogrock
;					fixed a targeting bug
;				Mudmartigan
;					Added 5s wait after named is dead
;			Eryslai: Trials of Air
;				Kamara Zar
...
;v6.06 Changes 8-5-19
;	Added:
;		RI_Infuse or RIF
;			Script to auto infuse your gear
;	ForWhoCheck
;		Added:
;			~IGW~ToonName
;				Checks if your in group with ToonName
;			~NIGW~ToonName
;				Checks if your not in group with ToonName
;			~IRW~ToonName
;				Checks if your in raid with ToonName
;			~NIRW~ToonName
;				Checks if your not in raid with ToonName
;	CB
;		***** 2019 CombatBot Revamp Stage #1 of Many *****
;		Modified alot of internal code to increase efficiency, much more to come in later stages
...
;		Added Automated Handling of Balanced Synergy
;			- Add this into the caststack on 1 toon in your group and it will manage it from there
;				- you can add it to multiple toons cast stacks but will only attempt to cast on the first toon
;					who encounters it in their stack after passing all checks
;	RI
;		Modified
;			Vegarlson: The Terene Rift
;				Now kills the 2 stone's in the first room
;			Awuidor: Marr's Ascent
;				Pathing tries to avoid Charming mobs now
;			Awuidor: Veiled Precipice
;				Moved LockSpots for Ring Events and Nameds out of water circle
;			Doomfire: Elements of Ragefire
;				Manacrush
;					Will now joust entire group and jousts a little less
;					Will kill embernauts if they add
;				Wrathflame
;					Only the MainToon will do the targeting now
;	RIS (RI_Salvage)
;		Now works with all same command line options as RIT (RI_Transmute) and RIE (RI_Extract)
;		when called with the -start flag, will automatically start and end script upon completion

;v6.07 Changes 8-28-19
;	RQ
;		Added:
;			Yet more "Travels" of Yun Zi - Once Again in the Desert
;				Please ensure you either have a Totem of Escape, Charm of Escape or an evac spell or this WILL fail
;	RI
;		Modified
;			Eryslai: The Bixel Hive
;				No longer attempts to retrieve shiny after last boss
;			Awuidor: The Veiled Precipice
;				Will now swim up if ever found in water
;	CB
;		***** 2019 CombatBot Revamp Stage #2 *****
;		Modified alot more internal code to increase efficiency
;		Fixed a bug that was not allowing to input Savagery on Beastlords

;v6.08 Changes 10-2-19
;	RQ
;		Added:
;			Yet more "Travels" of Yun Zi - Skies the Limit
;			Yet more "Travels" of Yun Zi - ECHO ECHo ECho Echo echo
;			Yet more "Travels" of Yun Zi - Rising to the Occasion
;			Yet more "Travels" of Yun Zi - More Moors
;			Yet more "Travels" of Yun Zi - Destined for Destiny

;v6.09 Changes 10-28-19
;	RQ
;		Added:
...
variable(global) float RI_Var_Float_Version=6.80
