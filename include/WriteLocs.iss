...
function main(... args)
{
	...
	RI_Index_String_AvailableRIWFunctionsDescription:Insert[CheckQuest - Checks the arguments and sets position in the Zone File to the highest passing argument\n\nAccepts an unlimited number of arguments in the form of any of the following\n-NotActiveQuest "Quest Name"\n-ActiveQuest "Quest Name"\n-CompletedQuest "Quest Name"]
