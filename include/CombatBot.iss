...
objectdef RI_Object_CB
{
	...
	method AddItem(string ItemName, string ItemEffect)
	{
		if ${ItemName.NotEqual[NULL]} && ${ItemName.NotEqual[""]} && ${ItemEffect.NotEqual[NULL]} && ${ItemEffect.NotEqual[""]}
		{
			...
			;need to rewrite item maintained check routine to use the listbox
...
;					&& ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].SelectedItem.Value.Token[3,|].NotEqual[InCombatTargeted]}
	...
	method AddCastStackAbilitiesListBoxItem(string _AbilityDisabled, string _AbilityName, int _ExportPosition, string _Type, string _Target, string _%, string _#, string _SD, string _SE, string _SAE, string _RIE , string _MAX, int _Savagery, int _DissonanceLess,int _DissonanceGreater)
	{
		...
		UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI]:AddItem[${temp},${_AbilityName}|${_ExportPosition}|${_Type}|${_Target}|${_%}|${_#}|${_SD}|${_SE}|${_SAE}|${_RIE}|${_MAX}|${_Savagery}|${_DissonanceLess}|${_DissonanceGreater}]
		...
		switch ${_Type}
		{
			case Hostile
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FFFF8080]
				break
			}
			case NamedHostile
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FFFF0000]
				break
			}
			case InCombatTargeted
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FF3F4591]
				break
			}
			case Power
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FF5DA5CF]
				break
			}
			case Heal
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FF00CD00]
				break
			}
			case Cure
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FF8C5B00]
				break
			}
			case Res
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FF992588]
				break
			}
			case Buff
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FFE8E200]
				break
			}
			case OutOfCombatBuff
			{
				UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}]:SetTextColor[FF75753B]
...
;						- FULLVALUE - ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${count}].Value}
				...
				;check if the ability is an AE, if so check mobs, use 3 for default, even tho ogre has a setting for it
				...
				;check if the ability is an Encounter, if so check mobs, use 3 for default, even tho ogre has a setting for it
